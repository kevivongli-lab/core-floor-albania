    ...
    <footer className="w-full bg-charcoal text-white">
      <div className="max-w-[100rem] mx-auto px-20 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16">
          {/* Company Info */}
          <div>
            <h3 className="font-heading text-3xl mb-6">CoreFloor Albania</h3>
            <p className="font-paragraph text-sm text-white/70 leading-relaxed mb-6">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-heading text-xl mb-6">Lidhje të Shpejta</h4>
          ...
          {/* Professional Links */}
          <div>
            <h4 className="font-heading text-xl mb-6">Për Profesionistë</h4>
            <ul className="space-y-3">
          ...
          {/* Brands */}
          <div>
            <h4 className="font-heading text-xl mb-6">Brand-et Tona</h4>
            <div className="space-y-4">
              <div>
                <p className="font-heading text-2xl text-white mb-1">FirmFit</p>
                <p className="font-paragraph text-xs text-white/60">SPC Project Grade</p>
              </div>
              <div>
                <p className="font-heading text-2xl text-white mb-1">Novocore</p>

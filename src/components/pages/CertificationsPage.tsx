...
export default function CertificationsPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
            ...
            {relevanceCategories.map((category, index) => (
              ...
              >
                <div className="w-16 h-16 bg-beige rounded-sm mx-auto mb-6 flex items-center justify-center">
                  <category.icon className="w-8 h-8 text-charcoal" strokeWidth={1.5} />
                </div>
      ...
      {/* Certifications List */}
      <section className="w-full py-24 bg-white min-h-[600px]">
        <div className="max-w-[100rem] mx-auto px-20">
                ...
                >
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    <div className="lg:col-span-3">
                      <div className="w-32 h-32 bg-white rounded-sm flex items-center justify-center mx-auto lg:mx-0">
                        {cert.icon ? (
                          <Image
                            src={cert.icon}

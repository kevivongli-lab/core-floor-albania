          ...
          <div className="flex flex-wrap gap-3 justify-center">
            {categories.map((category) => (
              <button
                ...
                className={`font-paragraph text-sm px-6 py-3 rounded-sm transition-all ${
      ...
      <section className="w-full py-24 bg-white">
        <div className="max-w-[100rem] mx-auto px-20 text-center">
          ...
          >
            ...
            <Button 
              size="lg" 
              className="bg-accent-gold hover:bg-accent-gold/90 text-white font-paragraph font-semibold px-10 py-6"
              onClick={() => window.location.href = '/kontakt'}
            >
              Kontakto Ekspertët
            </Button>
